from classifaudio.trainer import Trainer
from classifaudio.tester import Tester
from classifaudio.utils import folder2mfcc
...
class GaussianMixtureTrainer(Trainer):
   ...
   """
    ...
    def get_model(self, config):
        """
        Initialize a GaussianMixture model from config
...
class GaussianMixtureTester(Tester):
    ...
    def test_file(self, test_file, g_mixtures):
        ...
        for model in g_mixtures:
            pred[model] = g_mixtures[model].predict(mfcc_feat)
